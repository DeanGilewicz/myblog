	...
	<div id="comments" class="comments-area">
		...
		<div class="dg_grid_row">
			...
			<div class="dg_grid_col col_12">
				...
				<!--<h2 class="comments-title">
					<?php
						printf( _nx( 'One thought on &ldquo;%2$s&rdquo;', '%1$s thoughts on &ldquo;%2$s&rdquo;', get_comments_number(), 'comments title', 'thecodelog' ),
							number_format_i18n( get_comments_number() ), get_the_title() );
					?>
				</h2>-->

				<?php // thecodelog_comment_nav(); ?>
		...
		<div class="dg_grid_row">
			...
			<div class="dg_grid_col col_12">
				...
				?>
					<p class="no-comments"><?php _e( 'Comments are closed.', 'thecodelog' ); ?></p>
				<?php endif; ?>
