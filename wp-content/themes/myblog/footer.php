			...
			<div class="dg_grid_row">
				...
				<div class="dg_grid_col col_12">
					...
					<?php if ( has_nav_menu( 'primary' ) ) : ?>
						<nav class="main-navigation" role="navigation" aria-label="<?php esc_attr_e( 'Footer Primary Menu', 'myblog' ); ?>">
							<?php
								wp_nav_menu( array(
					...
					<?php if ( has_nav_menu( 'social' ) ) : ?>
						<nav class="social-navigation" role="navigation" aria-label="<?php esc_attr_e( 'Footer Social Links Menu', 'myblog' ); ?>">
							<?php
								wp_nav_menu( array(
